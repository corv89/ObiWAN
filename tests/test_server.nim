...
proc makeRawGeminiRequest(url: string): tuple[status: int, meta: string, body: string] =
...
proc testServerResponse(url: string, expectedStatus: int, expectedMeta: string = ""): bool =
